...
class Office(models.Model):
    ...
    slug = models.CharField(max_length=5, blank=True, null=True)
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="office_created_by"
    )
    last_modified_date = models.DateTimeField(
        null=False, blank=False, default=timezone.now
    )
    last_modified_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="office_last_modified_by"
    )
